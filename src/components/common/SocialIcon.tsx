...
const SocialIcon: React.FC<SocialIconProps> = ({ label, className = "w-5 h-5 md:w-6 md:h-6" }) => {
  ...
  return <MessageSquare className={className} aria-hidden="true" focusable="false" />;
};
